...
exports.getDateClasses = getDateClasses;
...
function getDateClasses(dateClasses) {
  var dateClassObj = {};

  if (dateClasses) {

    dateClasses.forEach(function (dateClass) {

      dateClass.dates.forEach(function (dateItem) {
        var year = dateItem.getFullYear();
        var month = dateItem.getMonth();
        var day = dateItem.getDate();
        var date = getDateString(year, month, day);
